...
public class CreateTemplateUserCommandHandler : IRequestHandler<CreateTemplateUserCommand, Guid>
{
    private readonly IAppDbContext _dbContext;
    public CreateTemplateUserCommandHandler(IAppDbContext dbContext) => _dbContext = dbContext;
